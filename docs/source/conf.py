# -*- coding: utf-8 -*-
#
# datalad_tabby documentation build configuration file, created by
        ...
        try:
            subprocess.run(
                args=[setup_py_path, 'build_manpage',
                     '--cmdsuite', 'datalad_tabby:command_suite',
                     '--manpath', abspath(opj(
...
# built documents.
version = datalad_tabby.__version__
release = version
